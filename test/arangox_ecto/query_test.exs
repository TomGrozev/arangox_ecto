  ...
  describe "create AQL query" do
    test "with select clause" do
      assert aql(from(u in User)) =~
               "FOR u0 IN `users` RETURN [ u0.`_key`, u0.`_id`, u0.`first_name`, u0.`last_name`, u0.`extra`, u0.`extra2`, u0.`gender`, u0.`age`, u0.`location`, u0.`class`, u0.`items`, u0.`inserted_at`, u0.`updated_at` ]"
    ...
    test "with where clause" do
      ...
      assert aql(from(u in User, where: u.first_name == ^first_name)) =~
               "FOR u0 IN `users` FILTER (u0.`first_name` == @1) RETURN [ u0.`_key`, u0.`_id`, u0.`first_name`, u0.`last_name`, u0.`extra`, u0.`extra2`, u0.`gender`, u0.`age`, u0.`location`, u0.`class`, u0.`items`, u0.`inserted_at`, u0.`updated_at` ]"

      assert aql(from(u in User, where: u.first_name == "Joe" and u.gender == :male)) =~
               "FOR u0 IN `users` FILTER ((u0.`first_name` == 'Joe') && (u0.`gender` == 0)) RETURN [ u0.`_key`, u0.`_id`, u0.`first_name`, u0.`last_name`, u0.`extra`, u0.`extra2`, u0.`gender`, u0.`age`, u0.`location`, u0.`class`, u0.`items`, u0.`inserted_at`, u0.`updated_at` ]"

      assert aql(from(u in User, where: u.first_name == "Joe" or u.gender == :female)) =~
               "FOR u0 IN `users` FILTER ((u0.`first_name` == 'Joe') || (u0.`gender` == 1)) RETURN [ u0.`_key`, u0.`_id`, u0.`first_name`, u0.`last_name`, u0.`extra`, u0.`extra2`, u0.`gender`, u0.`age`, u0.`location`, u0.`class`, u0.`items`, u0.`inserted_at`, u0.`updated_at` ]"
    end
    ...
    test "with limit and offset clauses" do
      assert aql(from(u in User, limit: 10)) =~
               "FOR u0 IN `users` LIMIT 10 RETURN [ u0.`_key`, u0.`_id`, u0.`first_name`, u0.`last_name`, u0.`extra`, u0.`extra2`, u0.`gender`, u0.`age`, u0.`location`, u0.`class`, u0.`items`, u0.`inserted_at`, u0.`updated_at` ]"

      assert aql(from(u in User, limit: 10, offset: 2)) =~
               "FOR u0 IN `users` LIMIT 2, 10 RETURN [ u0.`_key`, u0.`_id`, u0.`first_name`, u0.`last_name`, u0.`extra`, u0.`extra2`, u0.`gender`, u0.`age`, u0.`location`, u0.`class`, u0.`items`, u0.`inserted_at`, u0.`updated_at` ]"
  ...
  describe "create remove query" do
    ...
    test "with returning" do
      assert aql(from(u in User, where: u.first_name == "Joe", select: u), :delete_all) =~
               "FOR u0 IN `users` FILTER (u0.`first_name` == 'Joe') REMOVE u0 IN `users` RETURN [ OLD.`_key`, OLD.`_id`, OLD.`first_name`, OLD.`last_name`, OLD.`extra`, OLD.`extra2`, OLD.`gender`, OLD.`age`, OLD.`location`, OLD.`class`, OLD.`items`, OLD.`inserted_at`, OLD.`updated_at` ]"
  ...
  describe "create update query" do
    ...
    test "with returning" do
      assert aql(
               ...
               "FOR u0 IN `users` FILTER (u0.`first_name` == 'Joe') UPDATE u0 WITH {`age`: 42} IN `users` RETURN [ NEW.`_key`, NEW.`_id`, NEW.`first_name`, NEW.`last_name`, NEW.`extra`, NEW.`extra2`, NEW.`gender`, NEW.`age`, NEW.`location`, NEW.`class`, NEW.`items`, NEW.`inserted_at`, NEW.`updated_at` ]"
